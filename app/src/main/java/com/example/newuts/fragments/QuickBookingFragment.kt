...
import com.example.newuts.databinding.FragmentQuickBookingBinding
...
class QuickBookingFragment : Fragment() {
    ...
    private var _binding: FragmentQuickBookingBinding?=null
    ...
    override fun onCreateView(
        ...
        _binding= FragmentQuickBookingBinding.inflate(inflater,container,false)
